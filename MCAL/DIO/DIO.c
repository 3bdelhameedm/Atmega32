...
void DIO_SetPinDirection(DIO_PORTID port_ID ,DIO_PINID Pin,DIO_DIRECTION direction){
	...
	if(port_ID<=portD && Pin<=pin7) {
		...
		switch(port_ID){
		    ...
		    case portA: SET_BIT(DDRA_REG,direction); break;
		    case portB: SET_BIT(DDRB_REG,direction); break;
		    case portC: SET_BIT(DDRC_REG,direction); break;
		    case portD: SET_BIT(DDRD_REG,direction); break;
				}
			...
			case portA: CLR_BIT(DDRA_REG,direction); break;
			case portB: CLR_BIT(DDRB_REG,direction); break;
			case portC: CLR_BIT(DDRC_REG,direction); break;
			case portD: CLR_BIT(DDRD_REG,direction); break;
							}
    }
    }
    }
